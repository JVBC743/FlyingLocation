...
<!-- ============================================================NAV BAR=================================================================================== -->
    ...
    <?php
        ...
        if(isset($_POST["enviar_pergunta"])){
            ...
            if(isset($_POST["alternativa"])){
                ...
                //echo "Você selecionou uma alternativa.";
    ...
    ?>
        ...
        <?php if($cargo == "administrador"):  ?>
            ...
            <form action="tela_perguntas.php" method = "post">

                <input type="submit" name = "abrir_cadastro" value = "Abrir Tela de Cadastro de Perguntas">

            </form>

            <?php if(isset($_POST["abrir_cadastro"])): ?>
